...
export class WordService {
  ...
  findAll(): Observable<ListResponseModel<WordListModel>>{ 
    return this.httpClient.get<ListResponseModel<WordListModel>>(this.apiUrl+"find-all")
  }
  findByKey(key:string): Observable<SingleResponseModel<WordListModel>>{ 
    return this.httpClient.get<SingleResponseModel<WordListModel>>(this.apiUrl+"find-by-key/"+key)
  }
}