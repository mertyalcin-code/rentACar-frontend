...
export class AdditionalServiceItemService {
  ...
  findAll(): Observable<ListResponseModel<AdditionalServiceItemListModel>> {
    return this.httpClient.get<
      ListResponseModel<AdditionalServiceItemListModel>
    >(this.apiUrl + 'find-all');
  }
  findById(
    id: number
  ): Observable<SingleResponseModel<AdditionalServiceItemListModel>> {
    return this.httpClient.get<
      SingleResponseModel<AdditionalServiceItemListModel>
