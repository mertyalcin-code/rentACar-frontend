...
export class CustomerCardDetailService {
  ...
  findAllByCustomerId(
    customerId: number
  ): Observable<ListResponseModel<CustomerCardDetailListModel>> {
    return this.httpClient.get<ListResponseModel<CustomerCardDetailListModel>>(
      this.apiUrl + 'find-by-customer-id/' + customerId
    );
  }
  findById(
    id: number
  ): Observable<SingleResponseModel<CustomerCardDetailListModel>> {
    return this.httpClient.get<
      SingleResponseModel<CustomerCardDetailListModel>
