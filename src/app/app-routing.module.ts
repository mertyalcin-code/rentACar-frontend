...
const routes: Routes = [
  ...
  { path: 'corporate-customer', component:CorporateCustomerComponent,canActivate:[EmployeeGuard] },
  { path: 'individual-customer', component:IndividualCustomerComponent,canActivate:[EmployeeGuard] },
